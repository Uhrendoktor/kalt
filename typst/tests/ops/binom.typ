...
#binary_operation(
  ...
  (
    v1: $3$,
    v2: $mat(1, 2; 3, 4)$,
    e: $comp(mat(binom(3, 1), binom(3, 2); binom(3, 3), binom(3, 4)))$,
  ),
  (
    v1: $mat(1, 2; 3, 4)$,
    v2: $3$,
    e: $comp(mat(binom(1, 3), binom(2, 3); binom(3, 3), binom(4, 3)))$,
  ),
  (
    v1: $mat(1, 2; 3, -4)$,
    v2: $mat(1i, 2 + 1i; -3, 4)$,
    e: $comp(mat(binom(1, 1i), binom(2, 2+1i); binom(3, -3), binom(-4, 4)))$,
  ),
)
